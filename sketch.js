...
function setup() {
	...
	rect1=createSprite(width/2, 80, 200,20);
	rect1.shapeColor="red";

	rect2=createSprite(width/2, 80, 20,100);
	rect2.shapeColor="red";

	rect3=createSprite(width/2, 80, 20,100);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 rect1Body = Bodies.rectangle(400, 640, 200, 20 , {isStatic:true} );
	 World.add(world, rect1Body);
	 
	 rect2Body = Bodies.rectangle(300, 600, 20, 100 , {isStatic:true} );
